...
const Activities: NextPage = () => {
  return (
    <main>
      ...
      <HeroSection title="Our Goal">
        We strive to create a sustainable and inclusive solutions that are
        capable of ensuring livelihoods, improving food security and safety, and
        mitigating the climate risks.
      </HeroSection>
      <section className="">
        <div>
          <motion.h3
          ...
          <motion.p className="text-center px-16 mb-12">
            We are a Value-chain Development Firm that aims to grow, transport &
            transform crops into sustainable responsible products and
            commodities in rural areas with small-holder farmers for the purpose
            of offering these high-quality products in Local, ASEAN, and
          ...
          >
            ...
            >
              <Image
                ...
                height={80}
              />
              <p className="text-center text-md mt-4">Inputs Shop</p>
            </motion.div>
            ...
            <motion.div
              ...
              variants={slideIn}
            >
              <Image src={LineHorizontal} alt={"horizontal line"} width={80} />
            </motion.div>
            ...
            <motion.div
              ...
              variants={fadeUp}
            >
              <Image src={LineVertical} alt={"horizontal line"} height={100} />
            </motion.div>
            ...
            >
              <Image
                ...
                height={80}
              />
              <p className="text-center text-md mt-4">Contract Farming</p>
            </motion.div>
            ...
            >
              <Image
                ...
                height={80}
              />
              <p className="text-center text-md mt-4">Regional Market</p>
            </motion.div>
          </motion.div>
        </div>
        <div>
